...
class Match:
    ...
    @property
    def matchup_of_interest_ally(self):
        return deep_get(self.teams_info, f'ally.{self.ally_position_of_interest}.champion')

    @property
    def matchup_of_interest_enemy(self):
        return deep_get(self.teams_info, f'enemy.{self.ally_position_of_interest}.champion')
